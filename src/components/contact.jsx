          ...
          >
            ...
            <div className="space-y-6">
              ...
              <motion.a
                ...
                whileTap={{ scale: 0.98 }}
                className="flex items-center justify-center w-full bg-gradient-to-r from-green-500 to-green-600 text-white p-4 rounded-xl font-semibold text-medium shadow-lg hover:shadow-xl transition-all duration-300 hover:text-white  gap-2"
              >
                <svg
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <motion.a
                  ...
                  className="flex items-center justify-center p-3 border-2 border-purple-500 text-purple-700 rounded-xl font-medium hover:bg-gradient-to-r hover:from-purple-100 hover:to-pink-100 hover:border-purple-600 hover:shadow-lg transition-all duration-300"
                >
                  <MapPin className="w-5 h-5 mr-2" /> Ubicación
                </motion.a>
              </div>
            </div>
          </motion.div>
